...
function narrate() {
    ...
    function spies() {
        ...
        setTimeout(function () {
            JTura.style.backgroundImage = "url(images/josef_style3.png)";
        }, 1000);
        setTimeout(function () {
            proffesor.style.backgroundImage = "url(images/prof_style3.png)";
        }, 2000);
        setTimeout(function () {
            actress.style.backgroundImage = "url(images/maria-style3.png)";
        }, 3000);
        setTimeout(function () {
            JTura.style.backgroundImage = "url(images/josef_style4.png)";
        }, 4000);
        setTimeout(function () {
            proffesor.style.backgroundImage = "url(images/prof_style4.png)";
        }, 5000);
        setTimeout(function () {
            proffesor.style.backgroundImage = "url(images/actors.png)";
